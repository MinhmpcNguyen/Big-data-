...
docker exec -it data-platform-control-plane crictl rmi spark-weather-kafka:3.3.3-r3
docker build -t spark-weather-kafka:3.3.3-r5 .     
kind load docker-image spark-weather-kafka:3.3.3-r4 --name data-platform
